...
**Crystal Colon - I contributed to trying to debug processing.py, which is similar to what we worked on together over zoom before. I also inpendently tried to training and validating a CNN network. Lastly, I implemented the texture-based feature extraction.
